...
tech: ["SAP Business One", "PostgreSQL-based ERP", "Python", "T-SQL"]
order: 4
---
...
I integrate directly with production ERP environments, including SAP Business One and a PostgreSQL-based ERP platform, reverse-engineer the parts that matter, and build analytics pipelines that mirror the live system into a clean, BI-ready model.
