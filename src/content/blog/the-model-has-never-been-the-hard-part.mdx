...
I build AI systems on enterprise data for a living. The databases I work with have hundreds of tables, misspelt column names that downstream joins depend on, and business rules frozen into query expressions that nobody documented. One system stored user passwords in plaintext. Another had a column overloaded to mean four different things depending on which department entered the record.
